...
export const Sidebar = () => {
  ...
  const menuItems = [
    { to: "/profil", icon: <Grid2X2 size={20} />, text: "Profil" },
    { to: "/Gallery", icon: <Image size={20} />, text: "Album" },
    { to: "/acara", icon: <Calendar size={20} />, text: "Acara" },
    ...(user && user.name !== "Guest"
      ? [{ to: "/setting", icon: <Settings size={20} />, text: "Pengaturan" }]
      : []),
  ];
